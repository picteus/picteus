export default {
  ...
  emptyCollections: {
    title: "No collection",
    description:
      "It seems there are no collection configured at the moment. Please add a collection to better manage your images.",
  ...
  addOrUpdateCollectionModal: {
    ...
    commentPlaceholder: "All the images generated by MidJourney"
  },
  addExtensionModal: {
