...
|:---|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Extension does not start or load** | The `manifest.json` does not strictly validate against `manifest-v3.schema.json`. Check for missing required fields (`categories`, `runtimes`, `instructions`, `settings`), regex mismatches on IDs, or invalid JSON syntax. |
