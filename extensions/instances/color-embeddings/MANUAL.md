# Summary
This extension exposes 2 features:
- it computes vectorial embeddings for every indexed image and stores it ;
- it computes the dominant colors for every indexed image and stores it.
